...
map <C-Up> <Action>(ResizeToolWindowUp)
map <C-Down> <Action>(ResizeToolWindowDown)
map <C-Left> <Action>(ResizeToolWindowLeft)
map <C-Right> <Action>(ResizeToolWindowRight)
